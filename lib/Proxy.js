...
//{@dev
    Valid(Valid.type(url,      "String") && !URI.parse(url).error, Proxy_get, "url");
    Valid(Valid.type(callback, "Function"),                        Proxy_get, "callback");
//}@dev
...
function Proxy_getResponseHeader(name) { // @arg String
                                         // @ret String
//{@dev
    Valid(Valid.type(name, "String"), Proxy_getResponseHeader, "name");
//}@dev
...
//{@dev
    ...
    Valid(Valid.type(method, "String") && /^(GET|POST)$/.test(method), Proxy_open, "method");
    Valid(Valid.type(url,    "String") && !URI.parse(url).error, Proxy_open, "url");
    Valid(Valid.type(async,  "Boolean|omit"),               Proxy_open, "async");
    Valid(Valid.type(user,   "String|omit"),                Proxy_open, "user");
    Valid(Valid.type(password, "String|omit"),              Proxy_open, "password");
//}@dev
...
//{@dev
    Valid(Valid.type(mimeType, "String"), Proxy_overrideMimeType, "mimeType");
//}@dev
...
//{@dev
    Valid(Valid.type(name,  "String"), Proxy_setRequestHeader, "name");
    Valid(Valid.type(value, "String"), Proxy_setRequestHeader, "value");
//}@dev
