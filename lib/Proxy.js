// @name: Proxy.js
// @require: Valid.js, EventListener.js
...
Proxy["prototype"] = {
    ...
    "addEventListener":     Proxy_addEventListener,     // Proxy#addEventListener(type:String, callback:Function):this
    "removeEventListener":  Proxy_removeEventListener,  // Proxy#removeEventListener(type:String, callback:Function):this
    "clearEventListener":   Proxy_clearEventListener,   // Proxy#clearEventListener():this
    "on":                   Proxy_addEventListener,     // Proxy#on(type:String, callback:Function):this
    "off":                  Proxy_removeEventListener,  // Proxy#off(type:String, callback:Function):this
...
//{@assert
    _if(!Valid.type(type, "String"),       "Proxy#addEventListener(type)");
...
/*
    ...
    if (this._lv >= 2) {
        this._xhr["addEventListener"](type, callback, false);
    }
    this._attachedEvents[type] = callback;
...
//{@assert
    _if(!Valid.type(type, "String"),       "Proxy#removeEventListener(type)");
...
/*
    ...
    if (this._lv >= 2) {
        this._xhr["removeEventListener"](type, callback, false);
    }
    delete this._attachedEvents[type];
...
/*
    ...
    for (var type in eventTypes) {
        var callback = this._attachedEvents[type];
